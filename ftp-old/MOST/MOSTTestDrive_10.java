...
public class MOSTTestDrive_10 {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		//CR={<0, 0x1, 0x1, 0x1>, <1, 0x2, 0x2, 0x2>}, 
		//NM.Addr={0xffff, 0x0}, 
		//NS1.Add={0x1}, NS1.FB={<0, 0x1, 0x1, 0x1>}, 
		//NS2.Add={0x2}, 
		//NS2.FB={<1, 0x2, 0x2, 0xffff>, <1, 0x2, 0x2, 0x2>}
		
		//initialize node address list for nm and ns
		//0xFFFF as invalid, others as valid
		int [] nmAddr = new int[] {0xffff, 0x0};
		...
		FBlockIDEntry crfb1 = new FBlockIDEntry();
		crfb1.nodepos = 0;
		crfb1.NodeAddress = 0x1;
		crfb1.FBlockID = 0x1;
		crfb1.InstID = 0x1;
		CentralRegistry.insertNewEntry(crfb1);
		FBlockIDEntry crfb2 = new FBlockIDEntry();
		crfb2.nodepos = 1;
		crfb2.NodeAddress = 0x2;
		crfb2.FBlockID = 0x2;
		crfb2.InstID = 0x2;
		CentralRegistry.insertNewEntry(crfb2);
