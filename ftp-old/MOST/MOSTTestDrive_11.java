...
public class MOSTTestDrive_11 {
	...
	public static void main(String[] args) {
		...
		//NS1.Add={0x1}, 
		//NS1.FB={<0, 0xffff, 0x1, 0x1>, <0, 0x1, 0x1, 0x1>}, 
		//NS2.Add={0x2}, 
		//NS2.FB={<1, 0x2, 0x2, 0x2>}
		...
		FBlockIDEntry fb1_1 = new FBlockIDEntry();
		fb1_1.nodepos = 0; //start from 0
		fb1_1.NodeAddress = 0xffff;
		fb1_1.FBlockID = 0x1;
		fb1_1.InstID = 0x1;
		nsFBlockIDs1.add(fb1_1);
		FBlockIDEntry fb1_2 = new FBlockIDEntry();
		fb1_2.nodepos = 0; //start from 0
		fb1_2.NodeAddress = 0x1;
		fb1_2.FBlockID = 0x1;
		fb1_2.InstID = 0x1;
		nsFBlockIDs1.add(fb1_2);
